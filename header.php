                                ...
                                <ul class="dl-menu nav-list nav-list-primary" data-element="menu">
                                    ...
                                    if(isset($menu_obj) && !is_wp_error($menu_obj)) {
                                        ...
                                        <li class="text-redbrown menu-dropdown-simple-wrapper">
                                            <a class="toggle-dropdown toggle-dropdown-simple <?php echo $active_page == 'school' ? 'active' : ''?>" role="button" href="#" aria-expanded="false" id="mainNavDropdown1" title="Vai alla pagina: <?php _e("Scuola","design_laboratori_italia"); ?>"><?php _e("Scuola","design_laboratori_italia"); ?></a>
                        ...
                        <nav aria-label="Principale" class="main-nav" id="menu-principale">
                            <ul class="dl-menu nav-list nav-list-primary" data-element="menu">
                                ...
                                if(isset($menu_obj) && !is_wp_error($menu_obj)) {
                                    ...
                                    ?>
                                    <li class="text-redbrown menu-dropdown-simple-wrapper">
                                        <a class="nav-link dropdown-toggle <?php echo $active_page == 'school' ? 'active' : ''?>" data-toggle="dropdown"  role="button" href="#" aria-expanded="false" id="mainNavDropdown1"><?php _e("Scuola","design_laboratori_italia"); ?></a>
