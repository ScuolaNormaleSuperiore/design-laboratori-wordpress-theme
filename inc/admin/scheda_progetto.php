...
function dsi_register_scheda_progetto_post_type() {
	...
	/** scheda **/
	$labels = array(
		'name'          => _x( 'Schede Progetti', 'Post Type General Name', 'design_laboratori_italia' ),
		'singular_name' => _x( 'Scheda Progetto', 'Post Type Singular Name', 'design_laboratori_italia' ),
	...
	$args   = array(
		'label'         => __( 'Scheda Progetto', 'design_laboratori_italia' ),
		'labels'        => $labels,
        ...
        'map_meta_cap'    => true,
        'description'    => __( "I progetti creati dai docenti della scuola e a disposizione di tutti.", 'design_laboratori_italia' ),
	);
    ...
    $labels = array(
        'name'              => _x( 'Tipologia Progetto', 'taxonomy general name', 'design_laboratori_italia' ),
        'singular_name'     => _x( 'Tipologia Progetto', 'taxonomy singular name', 'design_laboratori_italia' ),
...
function dsi_add_scheda_progetto_metaboxes() {
    ...
    $cmb_sottotitolo->add_field( array(
        'id' => $prefix . 'tipologia',
        'name'        => __( 'Tipologia progetto *', 'design_laboratori_italia' ),
    ...
    $cmb_sottotitolo->add_field( array(
            'name'       => __('Partecipanti', 'design_laboratori_italia' ),
            'desc' => __( 'descrizione dei partecipanti al progetto' , 'design_laboratori_italia' ),
...
// todo: relazione persone con schede
    $cmb_sottotitolo->add_field( array(
            'name'       => __('Persone coinvolte', 'design_laboratori_italia' ),
            'desc' => __( 'Schede del personale scolastico coinvolto a vario titolo nel progetto' , 'design_laboratori_italia' ),
 ...
 * // todo: programma materia
	$cmb_sottotitolo->add_field( array(
			'name'       => __('Classi collegate ', 'design_laboratori_italia' ),
			'desc' => __( 'lista dei link alle sezioni che hanno partecipato' , 'design_laboratori_italia' ),
			'id'             => $prefix . 'classi',
			'type'    => 'pw_multiselect',
...
*/
    $cmb_sottotitolo->add_field( array(
            'name'       => __('In collaborazione con', 'design_laboratori_italia' ),
            'desc' => __( 'eventuale lista di enti pubblici, privati, associazioni, etc' , 'design_laboratori_italia' ),
	...
	$cmb_undercontent = new_cmb2_box( array(
		...
		'title' =>  __( 'Luogo, Strutture, Documenti, Gallery', 'design_laboratori_italia' ),
		'object_types' => array( 'scheda_progetto' ),
		'context'      => 'normal',
		'priority'     => 'high',
	) );
    ...
    $cmb_undercontent->add_field( array(
        ...
        'desc' => __( 'Seleziona se il progetto viene svolto in un <a href="edit.php?post_type=luogo">Luogo della Scuola</a>', 'design_laboratori_italia' ),
        'type'    => 'radio_inline',
        'options' => array(
    ...
    $cmb_undercontent->add_field( array(
		...
		'desc' => __( 'Selezione il <a href="edit.php?post_type=luogo">luogo </a> in cui si è tenuto il progetto' , 'design_laboratori_italia' ),
        'type'    => 'pw_multiselect',
        'options' =>  dsi_get_luoghi_options(),
        'attributes' => array(
            'placeholder' =>  __( 'Seleziona il luogo in cui si è tenuto il progetto', 'design_laboratori_italia' ),
...
//			'tilelayer'           => 'http://{s}.tile.osm.org/{z}/{x}/{y}.png',
	...
	$cmb_undercontent->add_field( array(
		...
		'name'    => __( 'Strutture', 'design_laboratori_italia' ),
		'before' => __( '<p>Relazione con le strutture che erogano il progetto. </p>' , 'design_laboratori_italia' ),
        'type'    => 'pw_multiselect',
    ...
    $cmb_undercontent->add_field( array(
        ...
        'name'    => __( 'Servizi', 'design_laboratori_italia' ),
        'desc' => __( 'Inserisci qui i servizi associati al progetto' , 'design_laboratori_italia' ),
    ...
    $cmb_undercontent->add_field( array(
        ...
        'desc' => __( 'Inserisci qui tutti i documenti che ritieni utili per descrivere il progetto. Se devi caricare il documento <a href="post-new.php?post_type=documento">puoi creare una breve scheda di presentazione</a> (soluzione consigliata e più efficace per gli utenti del sito). ' , 'design_laboratori_italia' ),
        'type'    => 'custom_attached_posts',
        'column'  => true, // Output in the admin post-listing as a custom column. https://github.com/CMB2/CMB2/wiki/Field-Parameters#column
        'options' => array(
            'show_thumbnails' => false, // Show thumbnails on the left
...
*/
    ...
    $cmb_undercontent->add_field( array(
        ...
        'desc'       => __( 'Galleria di immagini  significative relative al progetto, corredate da didascalia', 'design_laboratori_italia' ),
        'type' => 'file_list',
        // 'preview_size' => array( 100, 100 ), // Default: array( 50, 50 )
        'query_args' => array( 'type' => 'image' ), // Only images attachment
    ) );
    ...
    $cmb_risultati = new_cmb2_box( array(
        ...
        'title' =>  __( 'I Risultati', 'design_laboratori_italia' ),
        'object_types' => array( 'scheda_progetto' ),
        'context'      => 'normal',
        'priority'     => 'high',
    ) );
    ...
    $cmb_risultati->add_field( array(
        ...
        'name'        => __( 'Progetto Realizzato', 'design_laboratori_italia' ),
        'desc' => __( 'Seleziona se il progetto è concluso, e descrivine i risultati.' , 'design_laboratori_italia' ),
        'type'    => 'radio_inline',
        'options' => array(
            'true' => __( 'Si', 'design_laboratori_italia' ),
            'false'   => __( 'No', 'design_laboratori_italia' ),
    ...
    $cmb_risultati->add_field( array(
        'id' => $prefix . 'risultati',
        'name'        => __( 'Risultati', 'design_laboratori_italia' ),
        'desc' => __( 'Ampio testo descrittivo delle attività svolte nel progetto.<br>Se si desidera inserire un video di YouTube è necessaria l\'opzione "Enable privacy-enhanced mode" che permette di pubblicare il video in modalità youtube-nocookie.' , 'design_laboratori_italia' ),
        'type' => 'wysiwyg',
        'options' => array(
            'media_buttons' => false, // show insert/upload button(s)
    ...
    $cmb_side = new_cmb2_box( array(
		'id'           => $prefix . 'box_side',
		'title'        => __( 'Data Progetto', 'design_laboratori_italia' ),
		'object_types' => array( 'scheda_progetto' ),
		'context'      => 'side',
		'priority'     => 'high',
	) );
    ...
    $cmb_side->add_field( array(
        'name'    =>  __( 'Anno scolastico di riferimento', 'design_laboratori_italia' ),
        //'desc'    =>  __( 'Se non valorizzato verrà assegnato l\'anno in base alla data di inizo progetto, o in assenza alla data di pubblicazione.', 'design_laboratori_italia' ),
...
function sdi_scheda_progetto_add_content_after_title($post) {
	if($post->post_type == "scheda_progetto")
		_e('<span><i>il <b>Titolo</b> è il <b>Nome della Scheda Progetto</b>.  Vincoli: massimo 60 caratteri spazi inclusi</i></span><br><br>', 'design_laboratori_italia' );
}
...
function sdi_scheda_progetto_add_content_before_editor($post) {
	if($post->post_type == "scheda_progetto")
        _e('<h1>Descrizione Estesa e Completa del Progetto</h1>', 'design_laboratori_italia' );
