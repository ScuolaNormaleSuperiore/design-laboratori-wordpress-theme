...
class Patent_Manager {
	...
	function add_fields() {
		...
		'fields' => array(
			...
			array(
				'key' => 'field_67c9b79bdf4b9',
				'label' => 'Stato legale**',
				'name' => 'stato_legale_custom',
				'aria-label' => '',
				'type' => 'text',
				'instructions' => '',
				'required' => 0,
			...
			array(
				'key' => 'field_6760052a7260e',
				'label' => 'Altri inventori**',
				'name' => 'altri_inventori',
				'aria-label' => '',
				'type' => 'text',
				'instructions' => '',
				'required' => 0,
