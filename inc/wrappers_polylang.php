...
if ( ! function_exists( 'dli_current_language' ) ) {
	 ...
	 *
	 * @param string $type Format of the returned value: 'slug', 'locale', 'name' or 'id'.
	 * @return string
	 */
...
if ( ! function_exists( 'dli_languages_list' ) ) {
	 ...
	 *
	 * @param array $args Arguments forwarded to Polylang's pll_languages_list().
	 * @return array
	 */
...
if ( ! function_exists( 'dli_save_term_translations' ) ) {
	 ...
	 *
	 * @param array $related_taxonomies Array of term IDs, keyed by language slug.
	 * @return void
	 */
...
if ( ! function_exists( 'dli_save_post_translations' ) ) {
	 ...
	 *
	 * @param array $related_posts Array of post IDs, keyed by language slug.
	 * @return void
	 */
...
/**
 * Recupera l'URL della traduzione, nella lingua corrente, della pagina con lo slug indicato.
 *
 * @param string $slug Page slug (in the default language).
 * @return string Permalink of the translated page, or an empty string if not found.
 */
...
if ( ! function_exists( 'dli_homepage_url' ) ) {
	/**
	 * Recupera l'URL della home page nella lingua corrente.
	 *
	 * @return string
	 */
...
if ( ! function_exists( 'dli_get_configuration_field_by_lang' ) ) {
	/**
	 * Recupera il valore di un'opzione di configurazione nella lingua corrente,
	 * ricadendo sulla lingua di default se non è impostato.
	 *
	 * @param string $field_name Base option name (Italian variant, no language suffix).
	 * @param string $field_type CMB2 option group/box holding the field.
	 * @return mixed
	 */
