    ...
    <main id="main-container" class="main-container <?php echo $class; ?>>">
        ...
        <section class="section bg-white border-top border-bottom d-block d-lg-none">
            <div class="container d-flex justify-content-between align-items-center py-3">
                <h3 class="h6 text-uppercase mb-0 label-filter"><strong><?php _e("Filtri", "design_laboratori_italia"); ?></strong></h3>
                ...
                <div class="row variable-gutters sticky-sidebar-container">
                    ...
                    <div class="col-lg-7 offset-lg-1 pt84">
                        ...
                        <?php if(isset($_GET["archive"]) && ($_GET["archive"] == "true")){ ?>
                            <p><a class="btn btn-block btn-secondary" href="<?php echo get_post_type_archive_link("scheda_progetto"); ?>" ><?php _e("Consulta i progetti dell'anno in corso", "design_laboratori_italia"); ?></a></p>
                        <?php }else{ ?>
                            <p><a class="btn btn-block btn-secondary" href="<?php echo get_post_type_archive_link("scheda_progetto"); ?>?archive=true" ><?php _e("Consulta i progetti degli scorsi anni", "design_laboratori_italia"); ?></a></p>
                        <?php } ?>
                    </div><!-- /col-lg-8 -->
                </div><!-- /row -->
            </div><!-- /container -->
