...
- Non toccati in questa passata: `template-parts/common/sezione-persone.php` (già v3-compatibile), `sezione-related-items.php`/`sezione-related-technical-resources.php` (nessuna classe v2-only trovata).
