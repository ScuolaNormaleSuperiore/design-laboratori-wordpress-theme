<div d="pre-header" class="it-header-slim-wrapper bg-petrol">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div class="it-header-slim-wrapper-content">
						...
						<nav aria-label="Navigazione accessoria">
							<a class="it-opener d-lg-none" data-bs-toggle="collapse" href="#menu1a" role="button" aria-expanded="false" aria-controls="menu4">
								...
								<svg class="icon" aria-hidden="true">
									<use href="#it-expand" xlink:href="#it-expand"></use>
								</svg>
							</a>
					...
					<div class="it-header-slim-right-zone">
						<div class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false" data-focus-mouse="false">
						...
						<div class="it-access-top-wrapper header-utils">
							<?php
