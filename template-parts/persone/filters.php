 ...
 *     @type string    $filter_mode         Modalità filtro struttura: chip|combobox|disabled.
...
$dli_f_select_structure_enabled = ( 'disabled' !== $dli_f_filter_mode );
$dli_f_has_structures           = count( $dli_f_structures ) >= 1;

if (
	$dli_f_has_structures &&
	$dli_f_result_count &&
	$dli_f_select_structure_enabled &&
	'combobox' !== $dli_f_filter_mode
) :
	?>
	<div class="row mb-5">
...
<?php if ( $dli_f_select_structure_enabled || $dli_f_filter_level_enabled ) : ?>
	<div class="row mb-5">
		<div class="col-lg-3"></div>
		<div class="col-lg-4">
			<?php
		...
		<div class="col-lg-4">
			<?php if ( $dli_f_filter_level_enabled && count( $dli_f_tags ) > 0 ) : ?>
				<div class="select-wrapper">
