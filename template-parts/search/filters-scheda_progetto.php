				...
				foreach ( $terms as $term ) {
					...
					<li>
                        <div class="form-check my-0">
							<input type="radio" class="custom-control-input" name="tipologia-progetto" value="<?php echo $term->slug; ?>" id="check-<?php echo $term->slug; ?>" <?php if($term->slug == get_query_var("tipologia-progetto")) echo " checked "; ?> onChange="this.form.submit()">
