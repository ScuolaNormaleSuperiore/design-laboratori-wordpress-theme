...
$studenti = dli_get_option( "studenti", "la_scuola" );
$classi = dli_get_option( "classi", "la_scuola" );
...
?>
	...
	<section class="section section-padding py-5 bg-gray-light">
		<div class="container">
			<div class="row variable-gutters">
				<div class="col-md-6">
					<div class="title-section">
						...
						<p class="mb-0"><?php echo dli_get_option("numeri_descrizione", "la_scuola"); ?></p>
					</div><!-- /title-section -->
				</div><!-- /col-md-6 -->
			</div><!-- /row -->
			<div class="row variable-gutters">
			...
			<?php
			$url_scuoleinchiaro = dli_get_option( "url_scuoleinchiaro", "la_scuola" );
