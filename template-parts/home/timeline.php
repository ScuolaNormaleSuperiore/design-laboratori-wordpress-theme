...
// la storia
$timeline = dli_get_option( "timeline", "la_scuola" );
			...
			<div class="row variable-gutters mt-0 mt-xl-2">
				<div class="col">
					<div class="title-section text-center mb-5">
						<h3 class="mb-2" style="color: #ffffff;"><?php _e( "La Storia della scuola", 'design_laboratori_italia' ); ?></h3>
						<p style="color: #ffffff;"><?php echo dli_get_option( "descrizione_laboratorio", "la_scuola" ); ?></p>
					</div><!-- /title-section -->
				</div><!-- /col -->
			</div><!-- /row -->
