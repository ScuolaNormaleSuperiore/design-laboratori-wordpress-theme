<?php
	$featuredcontents_enabled = dli_get_option( 'home_publication_list_is_visible', 'homepage' );
	...
	<div class="section-content">
		...
		<div class="row">
			...
			foreach( $boxes as $index ) {
				...
				get_template_part( 'template-parts/home/card-pubblicazioni', null, array( $index, $label, $template, $pt, $num_items, true ) );
			}
			?>
			</div>
		</div>
