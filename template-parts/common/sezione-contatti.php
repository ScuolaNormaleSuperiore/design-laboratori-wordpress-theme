	...
	if ( $dli_phone || $dli_email || $dli_website ) {
		...
		<div class="it-list-wrapper">
			...
			if ( $dli_phone ) {
				?>
			<li>
				<a href="<?php echo 'tel:' . esc_attr( $dli_phone ); ?>" class="list-item" target="_blank">
					<div class="list-item">
						...
						<div class="it-right-zone">
							<span class="text"><?php echo esc_attr( $dli_phone ); ?></span>
						</div>
					</div>
				</a>
			</li>
			...
			if ( $dli_email ) {
				?>
			<li>
				<a href="<?php echo 'mailto:' . esc_attr( $dli_email ); ?>" class="list-item" target="_blank">
					<div class="it-rounded-icon">
					...
					<div class="it-right-zone">
						<span class="text"><?php echo esc_attr( $dli_email ); ?></span>
					</div>
				</a>
			</li>
				<?php
			...
			if ( $dli_website ) {
				?>
			<li>
				<a class="list-item" target="_blank" href="<?php echo esc_url( $dli_website ); ?>">
					<div class="it-rounded-icon">
