...
if($luogo->post_parent == 0){
	...
	$indirizzo = dli_get_meta("indirizzo", "_dsi_luogo_", $luogo->post_parent);
	$posizione_gps = dli_get_meta("posizione_gps", "_dsi_luogo_", $luogo->post_parent);
	$cap = dli_get_meta("cap", "_dsi_luogo_", $luogo->post_parent);
	$mail = dli_get_meta("mail", "_dsi_luogo_", $luogo->post_parent);
	$telefono = dli_get_meta("telefono", "_dsi_luogo_", $luogo->post_parent);
}
