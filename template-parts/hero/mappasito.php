...
?>
<section id="banner-persone" class="bg-banner-persone" aria-labelledby="dli-hero-mappasito-title">
	<div class="section-muted p-3 primary-bg-c1">
		<div class="container">
			<div class="hero-title text-left ms-4 pb-3 pt-3">
				<h2 id="dli-hero-mappasito-title" class="p-0  "><?php echo esc_html__( 'Mappa del sito', 'design_laboratori_italia' ); ?></h2>
