<?php
	$testo_sezione = dli_get_option( 'testo_sezione_progetti', 'progetti');
?>
				...
				<div class="row variable-gutters">
						<div class="col-md-5">
								<div class="hero-title text-left">
										...
										<h2 class="h4 font-weight-normal">TESTO SEZIONE ATTIVITA' DI RICERCA  (prenderlo da configurazione)<?php echo $testo_sezione; ?></h2>
								</div><!-- /hero-title -->
						</div><!-- /col-md-5 -->
				</div><!-- /row -->
		</div><!-- /container -->
