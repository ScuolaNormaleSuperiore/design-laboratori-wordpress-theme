<?php
/**
 * Template part: hero con breadcrumb integrato per la pagina elenco News.
 *
 ...
 * (sf-archivio-news.html) e in template-parts/hero/brevetti.php.
 *
 * @package Design_Laboratori_Italia
 */

$dli_testo_sezione = dli_get_configuration_field_by_lang( 'testo_notizie', 'notizie' );
?>

<section id="banner-news" class="it-hero-wrapper it-hero-small-size" aria-labelledby="dli-hero-news-title">
	<div class="container">
