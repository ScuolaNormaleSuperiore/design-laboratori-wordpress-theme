<?php
/**
 * Template part: hero con breadcrumb integrato per la pagina elenco Brevetti.
 *
 ...
 * (sf-elenco-brevetti.html) e in template-parts/hero/progetti.php.
 *
 * @package Design_Laboratori_Italia
 */

$dli_testo_sezione = dli_get_configuration_field_by_lang( 'testo_brevetti', 'brevetti' );
?>

<section id="banner-brevetti" class="it-hero-wrapper it-hero-small-size" aria-labelledby="dli-hero-brevetti-title">
	<div class="container">
		<div class="row align-items-stretch">
			<div class="col-12 col-lg-7">
				...
				<div class="it-hero-text-wrapper px-lg-2">
					<h2 id="dli-hero-brevetti-title"><?php echo esc_html( get_the_title() ); ?></h2>
