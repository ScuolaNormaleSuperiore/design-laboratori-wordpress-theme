<?php
/**
 * Template part: hero con breadcrumb integrato per la pagina elenco Risorse tecniche.
 *
 ...
 * (sf-elenco-risorse-tecniche.html) e in template-parts/hero/progetti.php.
 *
 * @package Design_Laboratori_Italia
 */

$dli_testo_sezione = dli_get_configuration_field_by_lang( 'testo_risorse_tecniche', 'risorse-tecniche' );
?>

<section id="banner-risorse-tecniche" class="it-hero-wrapper it-hero-small-size" aria-labelledby="dli-hero-risorse-tecniche-title">
	<div class="container">
		<div class="row align-items-stretch">
			<div class="col-12 col-lg-7">
				...
				<div class="it-hero-text-wrapper px-lg-2">
					<h2 id="dli-hero-risorse-tecniche-title"><?php echo esc_html( get_the_title() ); ?></h2>
