<?php
/**
 * Template part: hero con breadcrumb integrato per la pagina elenco Progetti.
 *
 ...
 * (sf-elenco-progetti.html) e in template-parts/hero/persone.php.
 *
...
<section id="banner-progetti" class="it-hero-wrapper it-hero-small-size" aria-labelledby="dli-hero-progetti-title">
	<div class="container">
		<div class="row align-items-stretch">
			<div class="col-12 col-lg-7">
				...
				<div class="it-hero-text-wrapper px-lg-2">
					<h2 id="dli-hero-progetti-title"><?php echo esc_html( get_the_title() ); ?></h2>
