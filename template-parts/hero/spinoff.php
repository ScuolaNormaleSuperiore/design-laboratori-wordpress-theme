<?php
/**
 * Template part: hero con breadcrumb integrato per la pagina elenco Spin-off.
 *
 ...
 * (sf-elenco-spinoff.html) e in template-parts/hero/progetti.php.
 *
...
<section id="banner-spinoff" class="it-hero-wrapper it-hero-small-size" aria-labelledby="dli-hero-spinoff-title">
	<div class="container">
