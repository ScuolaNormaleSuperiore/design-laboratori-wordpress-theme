...
$dli_cat_page       = DLI_PAGE_PER_CT[ NEWS_POST_TYPE ][ $dli_current_lang ];
				...
				<div class="col-12">
					<div class="it-hero-text-wrapper bg-dark">
						...
						<span class="it-Categoria">
							<?php echo esc_html( $dli_news_day ); ?>
							&nbsp;
							<?php echo esc_html( $dli_news_month ); ?>
						</span>
						<?php } ?>
			...
			<div class="row pt-0">
				...
				<div class="col-12 col-lg-2 border-end">
					...
					<div class="customSpacingDiv">
						<?php
							$dli_link_msg = __( 'Tutte le notizie', 'design_laboratori_italia' );
						?>
						<a class="customSpacing" href="<?php echo esc_url( $dli_pg_link ); ?>" title="<?php echo esc_attr( $dli_link_msg ); ?>"><?php echo esc_html( $dli_link_msg ); ?></a>
						<br /><br />
					</div>
