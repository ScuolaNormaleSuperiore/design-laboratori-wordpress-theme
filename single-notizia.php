...
$news_date      = dli_get_datetime_from_format( DLI_ACF_DATE_FORMAT, $date );
$news_day       = $news_date ? intval( $news_date->format( 'd' ) ) : '';
$news_month     = $news_date ? dli_get_monthname( $news_date->format( 'm' ) ) : '';
			...
			<div class="row pt-0">
				...
				<div class="col-12 col-lg-2 border-end">
					...
					<div class="customSpacingDiv">
						...
						?>
						<a class="customSpacing" href="<?php echo esc_url( $pg_link ); ?>" title="<?php echo esc_attr( $link_msg ); ?>" alt="<?php echo esc_attr( $link_msg ); ?>" ><?php echo esc_html( $link_msg ); ?></a>
						<br /><br />
					</div>
